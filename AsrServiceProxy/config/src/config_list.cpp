...
VectorConfigValue::const_reference ConfigList::operator[](VectorConfigValue::size_type n)
const {
    return VectorConfigValue::at(n);
}
...
void ConfigList::resize(VectorConfigValue::size_type n,
...
VectorConfigValue::const_iterator ConfigList::erase(VectorConfigValue::const_iterator pos) {
    return VectorConfigValue::erase(VectorConfigValue::begin() +
                                       std::distance<VectorConfigValue::const_iterator>(begin(), pos));
}

VectorConfigValue::const_iterator ConfigList::insert(VectorConfigValue::const_iterator pos,
        const VectorConfigValue::value_type& val) {
    return VectorConfigValue::insert(VectorConfigValue::begin() +
                                        std::distance<VectorConfigValue::const_iterator>(begin(), pos), val);
}
